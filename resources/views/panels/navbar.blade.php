...
{{--<a class="btn btn-danger" href="{{route('generar_pdf')}}">PDF</a>--}}
    ...
    margin-bottom: 0px;" id="btnactualizamoneda" class="btn btn-primary">Actualizar Valores</button><strong>Valor
              UDI: <label id="lbluid" style="color: green;">{{round($configAlertas->valor,6)}}</label>, TIIE28: <label id="lbltiie28"
            ...
            <div class="navbar-collapse" id="navbar-mobile">
              <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                ...
                <ul class="nav navbar-nav bookmark-icons">
                  ...
                  <li class="nav-item d-none d-lg-block"><a class="nav-link" href="/"
                                                            data-toggle="tooltip" data-placement="top" title="SIED"><h4>
                        Sistema de integración de Expedientes Digitales - @yield('title')</h4></a></li>
                </ul>
              </div>
              <ul class="nav navbar-nav float-right">
                  ...
                  <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    <li class="dropdown-menu-header">
                      <div class="dropdown-header m-0 p-2">
                        <h3 class="white">{{$numNotificaciones}} Nuevas</h3><span
                          class="grey darken-2">Notificaciones</span>
                      </div>
                    </li>
                    ...
                    <li class="dropdown-menu-footer"><a class="dropdown-item p-1 text-center"
                                                        href="{{route("verAlertas")}}">Leer Todas</a></li>
                  </ul>
                </li>
                <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                    ...
                    </span><span class="user-status"></span></div>
                ...
                <li class="nav-item d-none d-lg-block"><a class="nav-link" href="/"
                                                          data-toggle="tooltip" data-placement="top" title="SIED">
                    <h4> {{ Auth::user()->name }} {{ Auth::user()->lastname }}<br>
                      <small style="font-size: 8px;">Último
                        Acceso {{  date('d-m-Y H:i', strtotime(Auth::user()->last_access)) }}</small></h4></a>
                </li>
