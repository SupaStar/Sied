      ...
      <div class="col-sm-12">
        <div class="card overflow-hidden">
          <div class="card-content">
            <div class="card-body">
              ...
              <div class="tab-content pt-1">
                ...
                <div class="tab-pane" id="profile-just" role="tabpanel" aria-labelledby="profile-tab-justified">
                    ...
                    <form action="/clientes/fisicas/eperfil" method="POST" class="steps-validation wizard-circle" id="formss" name="formss">
                      @csrf
                    <input type="hidden" class="form-control required" id="id" name="id" >
                      ...
                      <div class="form-body">
                            <div class="row">
                              <div class="col-md-4">
                                  <div class="form-group">
                                    ...
                                    <input type="number" value="@if(isset($datos->monto)){{$datos->monto}}@endif" step="any" class="form-control required" id="monto" name="monto" >
                                  </div>
                              </div>
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="@if(isset($datos->tcredito)){{$datos->tcredito}}@endif" class="form-control required" id="tcredito" name="tcredito">
                                </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input type="text" value="@if(isset($datos->frecuencia)){{$datos->frecuencia}}@endif" class="form-control required" id="frecuencia" name="frecuencia">
                              </div>
                          </div>
                          <div class="col-12">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                                <div class="vs-radio-con vs-radio-primary">
                                  <input type="radio" name="actividad" value="@if(isset($datos->actividad)) true @else false @endif" >
                                  <span class="vs-radio vs-radio-lg">
                                    <span class="vs-radio--border"></span>
                                    <span class="vs-radio--circle"></span>
                                  </span>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                              <div class="vs-radio-con vs-radio-primary">
                                <input type="radio" name="propietario" value="@if(isset($datos->propietario)) true @else false @endif">
                                <span class="vs-radio vs-radio-lg">
                                  <span class="vs-radio--border"></span>
                                  <span class="vs-radio--circle"></span>
                                </span>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                            <div class="vs-radio-con vs-radio-primary">
                              <input type="radio" name="proovedor" value="@if(isset($datos->proovedor)) true @else false @endif">
                              <span class="vs-radio vs-radio-lg">
                                <span class="vs-radio--border"></span>
                                <span class="vs-radio--circle"></span>
                              </span>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                          <div class="vs-radio-con vs-radio-primary">
                            <input type="radio" name="dactividad" value="@if(isset($datos->dactividad)) true @else false @endif">
                            <span class="vs-radio vs-radio-lg">
                              <span class="vs-radio--border"></span>
                              <span class="vs-radio--circle"></span>
                            </span>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        <div class="vs-radio-con vs-radio-primary">
                          <input type="radio" name="dpasivos" value="@if(isset($datos->dpasivos)) true @else false @endif">
                          <span class="vs-radio vs-radio-lg">
                            <span class="vs-radio--border"></span>
                            <span class="vs-radio--circle"></span>
                          </span>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control required" id="dotro" name="dotro" value="@if(isset($datos->dotro)){{$datos->dotro}}@endif">
                  </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                    <div class="vs-radio-con vs-radio-primary">
                      <input type="radio" name="total" value="@if(isset($datos->total)) true @else false @endif">
                      <span class="vs-radio vs-radio-lg">
                        <span class="vs-radio--border"></span>
                        <span class="vs-radio--circle"></span>
                      </span>
            ...
            <div class="col-md-4">
              <div class="form-group">
                  <div class="vs-radio-con vs-radio-primary">
                    <input type="radio" name="aceptable" value="@if(isset($datos->aceptable)) true @else false @endif">
                    <span class="vs-radio vs-radio-lg">
                      <span class="vs-radio--border"></span>
                      <span class="vs-radio--circle"></span>
                    </span>
          ...
          <div class="col-md-4">
            <div class="form-group">
                <div class="vs-radio-con vs-radio-primary">
                  <input type="radio" name="difisil" value="@if(isset($datos->difisil)) true @else false @endif">
                  <span class="vs-radio vs-radio-lg">
                    <span class="vs-radio--border"></span>
                    <span class="vs-radio--circle"></span>
                  </span>
        ...
        <div class="col-md-12">
          <div class="form-group">
              ...
              <input type="text" class="form-control required" id="conducta" name="conducta"  value="@if(isset($datos->conducta)){{$datos->conducta}}@endif">
          </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control required" id="comentario" name="comentario"  value="@if(isset($datos->comentario)){{$datos->comentario}}@endif">
        </div>
    </div>
                <div class="col-12">
                            <button type="submit" class="btn btn-primary mr-1 mb-1">Guardar</button>
                            <button type="reset" class="btn btn-outline-warning mr-1 mb-1">Limpiar</button>
                        <a href="/clientes/fisica">   <button type="button" class="btn btn-outline-danger mr-1 mb-1">Cancelar</button></a>
                        </div>
