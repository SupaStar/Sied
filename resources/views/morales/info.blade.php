      ...
      <div class="modal-content">
        ...
        <form action="/morales/credito/pago" enctype="multipart/form-data" method="POST"
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <select required aria-label="NContrato" class="form-control" id="NContrato" name="NContrato">
                @foreach($creditos as $credito)
            ...
            <label>Moneda </label>
            <div class="form-group">
              <select required class="form-control required" id="moneda" name="moneda" onchange="cmoneda()">
                <option selected disabled>Seleccionar</option>
