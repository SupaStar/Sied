  ...
  <div class="row match-height">
              ...
              <div class="card-content">
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                  <div class="form-group">
                                      ...
                                      <input type="number" step="any" class="form-control required" id="monto" name="nombre" >
                                  </div>
                              </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control " id="frecuencia" name="apellidom">
                  </div>
              </div>
      ...
      <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control required" id="conducta" name="comentario">
        </div>
    </div>
                <div class="col-12">
