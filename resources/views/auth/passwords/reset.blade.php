          ...
          <div class="row m-0">
              ...
              <div class="col-lg-6 col-12 p-0">
                  <div class="card rounded-0 mb-0 px-2">
                      ...
                      <p class="px-2">Ingresa tu nueva contraseña.</p>
                              ...
                              @csrf
                                ...
                                <div class="row pt-2">
                                    <div class="col-12 col-md-6 mb-1">
                                        <a href="login" class="btn btn-outline-primary btn-block px-0">Cancelar</a>
                                    </div>
                                    <div class="col-12 col-md-6 mb-1">
                                        <button type="submit" class="btn btn-primary btn-block px-0">Cambiar</button>
                                    </div>
                                </div>
                            </form>
                          </div>
