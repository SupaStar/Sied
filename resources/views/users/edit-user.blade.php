      ...
      <div class="col-12">
          <div class="card">
              <div class="card-content">
                  <div class="card-body">
                      <form class="form" action="/usuarios/editado" method="post">
                        @csrf
                        <div class="form-body">
                              <div class="row">
                                  <div class="col-md-4 col-12">
                                      <div class="form-label-group">
                                      <input type="text" value="{{$user->name}}" id="first-name-column" class="form-control" placeholder="Nombre(s)" name="name" required>
                                          <label for="first-name-column">Nombre(s)</label>
                                      </div>
                                  </div>
                                  <div class="col-md-4 col-12">
                                      <div class="form-label-group">
                                          <input type="text" value="{{$user->lastname}}" id="last-name-column" class="form-control" placeholder="Apellido Paterno" name="lastname" required>
                                          <label for="last-name-column">Apellido Paterno</label>
                                      </div>
                                  </div>
                                  <div class="col-md-4 col-12">
                                      <div class="form-label-group">
                                          <input type="text" value="{{$user->o_lastname}}" id="city-column" class="form-control" placeholder="Apellido Materno" name="olastname" required>
                                          <label for="city-column">Apellido Materno</label>
                                      </div>
                                  </div>
                                  <div class="col-md-8 col-12">
                                    <div class="form-label-group">
                                        <input type="email" value="{{$user->email}}" id="country-floating" class="form-control" name="email" placeholder="Email" required readonly>
                               ...
                               <div class="col-md-6 col-12">
                                      <div class="form-label-group">
                                          <select class="form-control" id="basicSelect" name="rol" required>
                                              ...
                                              <option value="2" @if($user->role == 2) selected @endif>Analista</option>
                                          </select>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        <select class="form-control" id="basicSelect" name="status" required>
                                            ...
                                            <option value="Desactivado" @if($user->status == 'Desactivado') selected @endif>Desactivado</option>
                                        </select>
                                    </div>
                                </div>
                              <div class="col-12">
