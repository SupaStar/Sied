    	...
    	<div class="col-md-12">
    		<div class="card card-default">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12">
                            <strong>Autenticacion de 2 factores para usuarios administradores</strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <!-- Sign-in button -->
                    <button disabled class="mdl-button mdl-js-button mdl-button--raised" id="sign-in-button">Solicitar Código</button>
                  </form>
...
<script type="text/javascript">
    // Initialize Firebase
    var config = {
          apiKey: "AIzaSyDZNEoLJ6XH8sYRsDZj9zDtt3t2YYX1CnA",
          authDomain: "testing-1554815629097.firebaseapp.com",
          databaseURL: "https://testing-1554815629097.firebaseio.com",
          projectId: "testing-1554815629097",
          storageBucket: "testing-1554815629097.appspot.com",
          messagingSenderId: "29298899886",
          appId: "1:29298899886:web:b22cd6d28c9bf83110a63f",
          measurementId: "G-WTBDMDS990"
    };
